...
from sqlalchemy import CheckConstraint, ForeignKey, String, TIMESTAMP, text, UniqueConstraint
...
MemberRoleEnum      = ENUM("owner", "editor", "viewer", name="member_role",      create_type=False)
InvitationStatusEnum = ENUM("pending", "accepted", "rejected", "expired", name="invitation_status", create_type=False)
...
class ProjectInvitation(Base):
    ...
    __table_args__ = (
        CheckConstraint("role <> 'owner'", name="pi_role_not_owner"),
    )
    ...
    status: Mapped[str] = mapped_column(InvitationStatusEnum, nullable=False, server_default="pending")
