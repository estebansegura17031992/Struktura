...
TaskStatusEnum = ENUM(
    "abierto", "en_proceso", "completo", name="task_status", create_type=False
)
...
class Task(Base):
    ...
    status: Mapped[str] = mapped_column(
        TaskStatusEnum, nullable=False, server_default="abierto"
    )
    ...
    timer_disabled: Mapped[bool] = mapped_column(
...
class TaskAssignee(Base):
    ...
    __table_args__ = (UniqueConstraint("task_id", "user_id", name="ta_task_user_uk"),)
